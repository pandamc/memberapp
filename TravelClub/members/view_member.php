...
<form action="view_member.php" method="post" style="margin-bottom: 50px;">
	<div style="width: 30em;">
		...
		<label for="favoriteActivity">Favorite Activity</label>
		<select name="favoriteActivity" id="favoriteActivity" size="1">
...
<table style="width: 30em; border: 1px solid #666666;">
	<tr>
		<th>Web page</th>
